...
function OpenByDefaultDetails({ summary, children, defaultOpen = true }: { summary: string; children: ReactNode; defaultOpen?: boolean }) {
...
function FileDetails({ toolName, toolInput, toolResult, autoCollapse }: { toolName: string; toolInput: Record<string, unknown>; toolResult: Record<string, unknown>; autoCollapse?: boolean }) {
  ...
  switch (toolName) {
    ...
    case "write_file": {
      ...
      return (
        <OpenByDefaultDetails summary="View Content" defaultOpen={false}>
          {isPreviewable ? (
